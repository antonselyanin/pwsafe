...
public typealias Record = RecordData<RecordKey>

public enum RecordKey: RecordType {
    public typealias Key<FieldType> = FieldKey<RecordKey, FieldType>
    ...
    /// sourcery: type = String
    public static let username: Key<String> = key(0x04, ValueSerializers.strings)
    
    /// sourcery: type = String
    public static let notes: Key<String> = key(0x05, ValueSerializers.strings)
    
    /// sourcery: type = String
    public static let password: Key<String> = key(0x06, ValueSerializers.strings)
    
    /// sourcery: type = String
    public static let url: Key<String> = key(0x0d, ValueSerializers.strings)
